...
#### problem #1. 
FullHD Blu-Ray movies, using external FullHD BD player displayed at Original Aspect Ratio </br>
without 4K Scaler: Blu-Ray FullHD movies look small / there is a large black unused area around the image. </br>

LG monitor only has 2 options: </br>
...
but firmware does Not allow to Scale-Up Wide & Vertical. </br>
...
a PC BD-Drive is better vs. stand alone FullHD Blu-Ray player like Sony BDP-S380 with WQHD monitor </br>
4K BluRay movies require PC BD-drive Firmware modification, BD Units only play FullHD from factory. </br>
VLC player allows to change Crop & Aspect Ratio, MPV, Xine, etc... </br>
